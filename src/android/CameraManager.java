...
public final class CameraManager {
	...
	public static int mDesiredFacing = Camera.CameraInfo.CAMERA_FACING_FRONT;
	...
	public static void setDesiredFacing(String camera){
		if(camera.equals("front"))
			mDesiredFacing = Camera.CameraInfo.CAMERA_FACING_FRONT;
		else
			mDesiredFacing = Camera.CameraInfo.CAMERA_FACING_BACK;
	}
